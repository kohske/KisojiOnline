...
var shape_learn_inst = {
  ...
  stimulus: '<p><b>以下の教示をよく読んでから、実験を開始してください。</b></p>',
  choices: ['space'],
  prompt: `
<p><br/>画面に顔写真が出てきます。写真の顔の<b>「鼻の高さ」</b>を10段階で評価してください（1:とても低い〜10:とても高い）。<br/><br/>
顔写真が消えた後に回答画面が表示されるので、マウスで数字のボタンをクリックしてください。<br/><br/>
顔写真、回答時間ともに3秒間表示されます。回答が間に合わなくても自動的に進んでいきます。<br/><br/>
全部で`+shape_stim.length+`回の試行を実施します。<br/><br/>
教示を理解したら、スペースキーを押して、実験を開始してください。
</p>`,
  post_trial_gap: 500,      
};
...
var mean_learn_inst = {
  ...
  choices: ['space'],
  prompt: `
<p><br/>画面に顔写真が出てきます。写真の顔の人物が<b>「どの程度信頼できるか（信頼性）」</b>を10段階で評価してください（1:とても低い〜10:とても高い）。<br/><br/>
顔写真が消えた後に回答画面が表示されるので、マウスで数字のボタンをクリックしてください。<br/><br/>
顔写真、回答時間ともに3秒間表示されます。回答が間に合わなくても自動的に進んでいきます。<br/><br/>
全部で`+shape_stim.length+`回の試行を実施します。<br/><br/>
教示を理解したら、スペースキーを押して、実験を開始してください。
...
var recall_inst = {
  type: 'html-keyboard-response',
  stimulus: '<p><b>これから再認セッションを行います。以下の教示をよく読んでから、実験を開始してください。</b></p>',
  prompt: `
<p>顔写真が2枚ずつ、左右に並んで出てきます。<br/><br/>
左右のどちらか一方は、先程の実験中に呈示されたものです。<br/><br/>
どちらの顔写真が、先程の実験中に呈示されたものか、左右の矢印キーを押して回答してください。<br/><br/>
教示を理解したら、スペースキーを押して、実験を開始してください。
</p>`,
  choices: ['space'],
  post_trial_gap: 500,      
...
var learn_eval = {
  ...
  on_start: function(trial){
    if (trial.data.task == "形態") {
      trial.prompt = "<br/>鼻の高さは？<br/>1: とても低い - 10: とても高い";
    } else if (trial.data.task == "意味") {
      trial.prompt = "<br/>写真の人物の信頼性は？<br/>1: とても低い - 10: とても高い";
    }
    ct = trial;
  },
};
